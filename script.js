function formatMoney() {
    ...
    elements.forEach(element => {
        ...
        if (!isNaN(number)) { // Kiểm tra xem có phải là số hay không
            const formattedMoney = new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(number); // Định dạng số tiền thành tiền tệ Việt Nam (VND)
...
$(document).ready(function() {
    const products = [
        {   
            "id":1,
            "image": 'imgs/Image/image_prd_list/1.png',
            "name": "Screen protector for iPhone 15",
            "price": "10.00",
            "color":"Pink",
            "statement":"New",
            "number":1
        ...
        {
            "id":2,
            "image": 'imgs/Image/image_prd_list/2.png',
            "name": "Apple Care",
            "price": "250.00",
            "color":"Pink",
            "statement":"New",
        ...
        {   
            "id":3,
            "image": 'imgs/Image/image_prd_list/3.png',
            "name": "Charge 20W",
            "price": "25.000",
            "color":"Pink",
            "statement":"New",
        ...
        {
            "id":4,
            "image": 'imgs/Image/image_prd_list/4.png',
            "name": "iPhone 15 Case",
            "price": "50.00",
            "color":"Pink",
            "statement":"New",
        ...
        {
            "id":5,
            "image": 'imgs/Image/image_prd_list/5.png',
            "name": "AirPods 3",
            "price": "150.00",
            "color":"Pink",
            "statement":"New",
    ...
    products.forEach(product => {
        ...
        <div class="d-flex flex-column justify-content-center align-items-center px-2" style="width:100%;">
